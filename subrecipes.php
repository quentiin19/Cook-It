...
$pdo = connectDB();
$queryPrepared = $pdo->prepare("SELECT RECIPES.ID_RECIPE, RECIPES.PICTURE_PATH, RECIPES.TITLE, RECIPES.ID_CREATOR, USER.PSEUDO from RECIPES, SUBSCRIPTION, USER where  RECIPES.ID_CREATOR = SUBSCRIPTION.ID_SUBSCRIPTION AND USER.ID_SUBSCRIBER = :id ID order by RECIPES_SAVED.DATE_SAVED DESC");
