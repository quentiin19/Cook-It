...
$pdo = connectDB();
$queryPrepared = $pdo->prepare("SELECT *, DATE_SAVED FROM RECIPES, RECIPES_SAVED WHERE RECIPES.ID_RECIPE IN (SELECT ID_RECIPE FROM RECIPES_SAVED WHERE ID_USER = :id) GROUP BY RECIPES.ID_RECIPE ORDER BY DATE_SAVED ASC;");
