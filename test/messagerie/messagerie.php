                ...
                <div id="message-canva" class="card-body" data-mdb-perfect-scrollbar="true" style="position: relative; height: 400px">
                    ...
                    <div class="d-flex flex-row justify-content-end mb-4 pt-1">
                        <div>
                            ...
                            <p class="small p-2 me-3 mb-1 text-white rounded-3 bg-primary">Long time no see! Tomorrow ofdddddddddddddddfdfdfdfkdfdlfkldkfldfkldkfldklfdkfldkdflfice. will be free on sunday.</p>
