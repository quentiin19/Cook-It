								...
								<div class="row">
									...
									<!-- Information du Compte -->
										<form method="POST" action="UpdateUser.php">
											...
											Votre Descriptin :<textarea row=3 type="text" class="form-control" name="description" placeholder="Votre description"  required="required" value=" <?=$results["DESCRIPTION_PROFIL"]?>"><br>
