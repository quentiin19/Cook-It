...
if(count($errors) == 0){
    ...
    $msg = '<a href=http://51.255.172.36/test/TestConfirmMail/verif.php?id='.$_SESSION['id'].'&cle='.$cle.'>Confirmer</a><h1>Cliquez sur le lien de confirmation juste au dessus</h1>';
