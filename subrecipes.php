...
$queryPrepared = $pdo -> prepare("SELECT RECIPES.ID_RECIPE, RECIPES.PICTURE_PATH, RECIPES.TITLE, RECIPES.ID_CREATOR, USER.PSEUDO FROM RECIPES, USER WHERE RECIPES.ID_CREATOR in ( SELECT ID_SUBSCRIPTION FROM SUBSCRIPTION) AND SUBSCRIPTION.ID_SUBSCRIBER = :id ")
