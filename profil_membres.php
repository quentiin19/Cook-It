								...
								<div class="col-lg-8 col-md-12 col-sm-12 bg-color arrondie">
									...
									<form method="POST" action="UpdateUser.php">
										<div class="py-3">
											...
											Votre Description :<textarea row=3 type="text" class="form-control" name="description" placeholder="Votre description"  value=" <?= $results["DESCRIPTION_PROFIL"] ?>"></textarea><br>
